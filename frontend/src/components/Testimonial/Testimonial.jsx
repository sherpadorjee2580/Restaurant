...
const Testimonial = () => {
  const reviews = [
    {
      id: 1,
      name: "Tshering Hyolmo",
      prof: "Student",
      img: "tshering.jpeg",
      text: "Very Very tasty food",
    },
    {
      id: 2,
      name: "Indra Tamang",
    ...
    },
    {
      ...
      prof: "Studnet",
      img: "dipesh.jpeg",
      text: "Mitho ko ta sima nai xaina ya ko khana ko ",
    },
    {
      id: 4,
      name: "Krinjal KC",
      prof: "Studnet",
      img: "krinjal.jpeg",
      text: "Wow ! So delicious mouth watering Foods ",
    },
  ];
